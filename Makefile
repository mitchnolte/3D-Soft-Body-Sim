...
OBjECTS := src/main.o src/shaders.o src/renderer.o src/camera.o src/mesh.o\
           src/simulation.o src/vector.o src/rk4_solver.o src/soft_body.o src/soft_shapes.o

$(TARGET): $(OBjECTS)
	g++ -o $(TARGET) $(OBjECTS) $(LIBS)


src/main.o: src/shaders.h src/renderer.h src/simulation.h src/soft_shapes.h src/vector.h
...
src/soft_shapes.o: src/soft_shapes.h
...
src/soft_shapes.h: src/soft_body.h
